 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.0.5/r-3.0.2/sp-2.3.1
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 2.0.5, Responsive 3.0.2, SearchPanes 2.3.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/dt-2.0.5/r-3.0.2/sp-2.3.1",
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sInfoFiltered": "(Von gesamt _MAX_ Einträgen)",
